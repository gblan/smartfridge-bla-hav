...
public class MenuController {
	...
	public MenuController(FridgeManager fridge) {
		...
		this.leftControl.getView().getUndoButton()
				.addActionListener(buttonUndoListener);
		this.leftControl.getView().getRedoButton()
				.addActionListener(buttonRedoListener);
		this.leftControl.getView().getRemoveButton()
				.addActionListener(buttonRemoveListener);
		this.leftControl.getView().getSortBy()
				.addActionListener(sortByListener);
	}
