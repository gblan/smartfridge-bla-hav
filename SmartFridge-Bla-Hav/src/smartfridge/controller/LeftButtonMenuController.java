...
private MouseListener redobuttonListener = new MouseListener() {
		...
		public void mouseExited(MouseEvent e) {
				((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/RedoButton.png"));			
		}
		
		@Override
		public void mouseEntered(MouseEvent e) {
			if(((AbstractButton) e.getSource()).isEnabled()){
				((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/RedoButtonFocus.png"));
			}
	...
	private MouseListener undobuttonListener = new MouseListener() {
		...
		public void mouseReleased(MouseEvent e) {
			if(!((AbstractButton) e.getSource()).isEnabled()){
				((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/UndoButton.png"));
			}						
		}
		...
		public void mouseEntered(MouseEvent e) {
			if(((AbstractButton) e.getSource()).isEnabled()){
				((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/UndoButtonFocus.png"));
			}
	...
	private MouseListener checkbuttonListener = new MouseListener() {
		...
		@Override
		public void mouseExited(MouseEvent e) {
			((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/buttonCheck.png"));
			
		}
		
		@Override
		public void mouseEntered(MouseEvent e) {
			((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/buttonCheckFocus.png"));
	...
	private MouseListener removebuttonListener = new MouseListener() {
		...
		@Override
		public void mouseExited(MouseEvent e) {
			((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/removeAllSmall.png"));
			
		}
		
		@Override
		public void mouseEntered(MouseEvent e) {
			((AbstractButton) e.getSource()).setIcon(new ImageIcon("resources/removeAllSmallFocus.png"));
